...
//                
            ...
            foreach($mikes as $timeframe) {
                ...
                for($t = 0; $t < $countTimeframe; $t++) {
                    ...
                    // id 334 is the last post that we added and stopped absolutely positioning
                    if($post_id > 304) {
                    	$classes = "";
                    	$position = 'left: '.$positionLeft.'px; top: '.$positionTopRand.'px; ';
                    } else {
                    	$classes = "element-" . $post_id . " hasPosition";
                    	$position = "";
                    }
                    
                    if(empty($thumbnail) && empty($media)) {
                        // post with text output
                        // style="left: {$positionLeft}px; top: {$positionTopRand}px;"
                        $output = <<<TEXT
                        <div class="mover text $classes" style="$position">
                            <article>
                                <h3>
                                    $title
                                </h3>
...
//                        $content = preg_replace($content);
                        ...
                        $output = <<<IMAGE
                        <div class="mover thumbnail $classes" style="$position $border">
...
//                        $media = strstr($media, '<p>', true);
                        ...
                        $output = <<<MEDIA
                        <div class="mover media $classes" style="$position">
                            <article>
                                    $media
                            </article>
...
MEDIA;
                        ...
                        $output = <<<CUT_OUT
                        <div class="mover cutout $classes" style="$position">
                            <article>
                                <p>
                                    $thumbnail
                                </p>
